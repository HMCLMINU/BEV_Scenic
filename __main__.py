...
simOpts.add_argument('--mode', help='purpose of sim (default 0 is for bev)',
                     type=int, default=0)
...
def runSimulation(scene):
    ...
    if args.verbosity >= 1:
        ...
        # os.system('/home/hmcl/carla-birdeye-view/bev_datagen/carla-birdeye-view/carla_birdeye_view/run.sh') # launch BEV sh file
