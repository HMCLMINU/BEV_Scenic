...
try:
    sys.path.append(glob.glob('/home/hmcl/carla12/PythonAPI/carla/dist/carla-*%d.%d-%s.egg' % (
...
import carla_birdeye_view.mask as mask
...
DEFAULT_HEIGHT = 224  # its 84m when density is 4px/m
DEFAULT_WIDTH = 224  # its 37.5m when density is 4px/m
...
class BirdViewProducer:
    ...
    def __init__(
        ...
        # print("here: {}".format(self.masks_generator))
    ...
    def produce(self, agent_vehicle: carla.Actor) -> BirdView:
        ...
        # print("{}".format(cropping_rect.vslice))
        # print("{}".format(cropping_rect.hslice))
        # print("{}".format(self.full_road_cache[cropping_rect.vslice, cropping_rect.hslice]))
        # print("{}".format(cropping_rect.vslice))
        # print("{}".format(self.full_road_cache))
    ...
    def apply_agent_following_transformation_to_masks(
        ...
        rotated = rotate(crop_with_centered_car, 0, center=rotation_center)
